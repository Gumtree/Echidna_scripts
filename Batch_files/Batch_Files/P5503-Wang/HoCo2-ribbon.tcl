...
# samplename HoCo2ribbon at 15K, 0T
# runscan stth 2.75 5.2 50 time 95
...
foreach one_field $fieldlist {
	gotofield $last_field $one_field 0.45
	set last_field $one_field
	samplename HoCo2ribbon in 6 mm V can 150K, $one_field T
	runscan stth 2.75 5.2 50 time 59
}
...
samplename HoCo2ribbon at 50K, 0T
runscan stth 2.75 5.2 50 time 95
...
foreach one_field $fieldlist {
	gotofield $last_field $one_field 0.45
	set last_field $one_field
	samplename HoCo2ribbon in 6 mm V can 50K, $one_field T
	runscan stth 2.75 5.2 50 time 59
}
hset /sample/tc1/temp0/setpoint 85
reset_field 6

drive tc1_temp0_setpoint 85
wait 900

samplename HoCo2ribbon at 85K, 0T
runscan stth 2.75 5.2 50 time 95
...
foreach one_field $fieldlist {
	gotofield $last_field $one_field 0.45
	set last_field $one_field
	samplename HoCo2ribbon in 6 mm V can 85K, $one_field T
	runscan stth 2.75 5.2 50 time 59
}
...
samplename HoCo2ribbon at 95K, 0T
runscan stth 2.75 5.2 50 time 95
...
foreach one_field $fieldlist {
	gotofield $last_field $one_field 0.45
	set last_field $one_field
	samplename HoCo2ribbon in 6 mm V can 95K, $one_field T
	runscan stth 2.75 5.2 50 time 59
}
...
samplename HoCo2ribbon at 150K, 0T
runscan stth 2.75 5.2 50 time 95
