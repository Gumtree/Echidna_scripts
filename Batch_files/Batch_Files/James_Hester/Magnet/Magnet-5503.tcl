...
samplename HoCo2Mn02 at 50K, 0T
runscan stth 2.75 5.2 50 time 95
...
samplename HoCo2Mn02 at 100K, 0T
runscan stth 2.75 5.2 50 time 95
...
foreach one_field $fieldlist {
	gotofield $last_field $one_field 0.45
	set last_field $one_field
	samplename HoCo2Mn02 in 6 mm V can 100K, $one_field T
	runscan stth 2.75 5.2 50 time 59
}
...
samplename HoCo2Mn02 at 150K, 0T
runscan stth 2.75 5.2 50 time 95
...
foreach one_field $fieldlist {
	gotofield $last_field $one_field 0.45
	set last_field $one_field
	samplename HoCo2Mn02 in 6 mm V can 150K, $one_field T
	runscan stth 2.75 5.2 50 time 59
}
...
samplename HoCo2Mn02 at 220K, 0T
runscan stth 2.75 5.2 50 time 95
...
foreach one_field $fieldlist {
	gotofield $last_field $one_field 0.45
	set last_field $one_field
	samplename HoCo2Mn02 in 6 mm V can 220K, $one_field T
	runscan stth 2.75 5.2 50 time 59
}
