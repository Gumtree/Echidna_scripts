...
#drive tc1 700
tc1 ramprate 1000
set templist [list 800 1000 1200]
foreach cel_temperature $templist {
samplename [ concat BaCeO3-$cel_temperature ]
...
# drive tc1_setpoint $cel_temperature
# wait 1200
# runscan stth 1.5 5.125 30 time 200
}
}


# Do a room temperature run before starting
# samplename BaCeO3-test (in Vac Furnace)
# runscan stth 1.5 5.125 30 time 100
tc1 ramprate 1000
drive tc1_setpoint 730
runtemps_list
# tc1 ramprate 10000
