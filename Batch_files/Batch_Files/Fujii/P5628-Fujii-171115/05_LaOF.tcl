...
samplename [ concat LaOF-$cel_temperature ]
...
drive tc1_setpoint $cel_temperature
wait 1200
runscan stth 1.5 5.125 30 time 180
}
}
...
#drive tc1 700
tc1 ramprate 1000
set templist [list 600]
foreach cel_temperature $templist {
samplename [ concat LaOF-1st-$cel_temperature ]
# adjust West 400 max power to improve stability,
# but no more than 45 percent
set maxpower [expr $cel_temperature/19]
if {$maxpower > 45} then {set maxpower 45}
...
drive tc1_setpoint $cel_temperature
wait 1200
runscan stth 1.5 5.125 30 time 90
samplename [ concat LaOF-2nd-$cel_temperature ]
runscan stth 1.5 5.125 30 time 180
}
}

# Do a room temperature run before starting
samplename LaOF-test (in Vac Furnace)
runscan stth 1.5 5.125 30 time 45
runtemps_list
runtemps_list_HT
tc1 ramprate 10000
