...
#drive tc1 700
tc1 ramprate 1000
set templist [list 200 400 600 800 900 1000 1100 1200]
foreach cel_temperature $templist {
samplename [ concat PNCG_1Au_liq-$cel_temperature ]
...
wait 5
drive tc1_setpoint $cel_temperaturedrive
wait 1200
runscan stth 1.5 5.125 30 time 350
}
}


# Do a room temperature run before starting
samplename PNCG_1Au_liq-test (in Vac Furnace)
runscan stth 1.5 5.125 30 time 175
runtemps_list
tc1 ramprate 10000
