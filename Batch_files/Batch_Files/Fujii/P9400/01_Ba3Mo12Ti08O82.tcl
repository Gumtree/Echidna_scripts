...
#drive tc1 700
tc1 ramprate 1000
set templist [list 200 400 500 550 600 650 700 800 600 400 200]
foreach cel_temperature $templist {
samplename [ concat Ba3Mo1.2Ti0.8O8.2-$cel_temperature ]
...
drive tc1_setpoint $cel_temperature
wait 1200
runscan stth 1.5 5.125 30 time 250
...
samplename Ba3Mo1.2Ti0.8O8.2-test (in Vac Furnace)
