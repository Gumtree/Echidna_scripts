...
#drive tc1 700
tc1 ramprate 1000
set templist [list 200 400 600 800 1000 1200]
foreach cel_temperature $templist {
samplename [ concat Ba7Nb39Cr01Mo20-$cel_temperature ]
...
drive tc1_setpoint $cel_temperature
wait 1200
runscan stth 1.5 5.125 30 time 260
...
samplename Ba7Nb39Cr01Mo20-test (in Vac Furnace)
