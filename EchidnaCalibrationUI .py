...
__script__.dict_path = gumtree_root + '/Echidna/ECH/path_table'
...
def __run_script__(fns):
    ...
    from Echidna.Reduction import Reduction
    ...
    van_sum = Reduction.getSummed(van, floatCopy=False, applyStth=False, show=False)
    bkg_sum = Reduction.getSummed(bkg, floatCopy=False, applyStth=False, show=False)
    ...
    if eff_make.value:
        ...
        eff = Reduction.getEfficiencyCorrectionMap(van_sum, bkg_sum, ok_map, show=True)
